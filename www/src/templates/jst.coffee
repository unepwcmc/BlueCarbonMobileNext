...
window.JST['area/login'] = _.template(
  """
    ...
    <form id="login-form" onSubmit="return false;">
      ...
      <a id="login" class='btn'>Sign In</a> <img src="dist/images/timer.gif" class="loading-spinner" />
    </form>
  """
)
...
window.JST['area/validation'] = _.template(
  """
    ...
    <img class='delete-validation' src="dist/images/trash_can.png"/>
