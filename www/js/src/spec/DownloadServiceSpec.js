...
(function() {
  describe("DownloadService", function() {
    ...
    return describe('.downloadBaseLayer', function() {
      ...
      return it('downloads the base layer', function(done, fail) {
        var offlineLayer, saveTilesMethod;
        saveTilesMethod = function(zoom, startcb, cb, errorcb) {
          return cb();
        };
        offlineLayer = {
          saveTiles: saveTilesMethod
        };
